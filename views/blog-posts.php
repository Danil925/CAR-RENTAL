...
<header data-spy="affix" data-offset-top="39" data-offset-bottom="0" class="large">
    ...
    <div class="row container box">
        <div class="col-md-5">
            <!-- Logo start -->
            <div class="brand">
                <h1><a class="scroll-to" href="index.phtml#top"><img class="img-responsive" src="../img/logo.gif" alt="Car|Rental"></a></h1>
            </div>
            <!-- Logo end -->
        </div>
            ...
            <nav class="navbar navbar-default" role="navigation">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand scroll-to" href="index.phtml#top"><img class="img-responsive" src="../img/logo.gif" alt="Car|Rental"></a>
                    </div>
                    <!-- Collect the nav links, for toggling -->
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <!-- Nav-Links start -->
                        <ul class="nav navbar-nav navbar-right">
                            <li class="active"><a href="index.phtml#top" class="scroll-to">Home</a></li>
                            <li><a href="index.phtml#services" class="scroll-to">Services</a></li>
                            <li><a href="index.phtml#vehicles" class="scroll-to">Vehicle Models</a></li>
                            <li class="dropdown">
                            ...
                            <li><a href="index.phtml#locations" class="scroll-to">Locations</a></li>
                            <li><a href="index.phtml#contact" class="scroll-to">Contact</a></li>
                        </ul>
                        <!-- Nav-Links end -->
                    </div>
                </div>
